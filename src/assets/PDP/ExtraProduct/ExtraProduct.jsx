...
export default function ExtraProduct({ brandName }) {
  const [product, setProduct] = useState([]);

  const GetProduct = () => {
    const a = "";
    GlobalApi.GetProducts(a, brandName).then((res) => {
      console.log("ExtraProduct", res);
      setProduct(res.products);
    });
  };

  useEffect(() => {
    console.log("ExtraProduct", brandName);
    GetProduct();
  }, []);
