...
export default function SignUp() {
  ...
  return (
    ...
    <>
                ...
                <code className='mt-4 flex' style={{ fontSize:13 }}>If you are already a member, Go to login</code>
                <form action="" onSubmit={handelSignup} className='flex flex-col gap-4'>
                  <input className='p-2 mt-8 rounded-xl border shadow-inner' type="text"
                   ...
                   required
                   />
                  <input className='p-2 rounded-xl border shadow-inner' type="text"
                   name='Lastname'
                   id='Lastname'
                  ...
                  <input className='p-2 rounded-xl border w-full shadow-inner' type="password"
                   name='password'
                   id='password'
                   ...
                   active:border-b-[2px] active:brightness-90 active:translate-y-[2px]'>SignUp</button>
                   </div>
                   <span className='text-sm cursor-pointer  ' style={{ marginLeft:"13rem" }} onClick={()=>navigate('/Login')} ><u>Login</u> </span>
                </form>
